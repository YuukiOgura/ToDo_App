<!-- ブラウザサイズの場合 -->
<button type="button"
  id="create-task-trigger-desktop"
...
<button type="button"
  ...
  data-hs-overlay="#hs-task_create-modal-{{ $user->id }}">
  <img src="{{ Vite::asset('resources/images/icon/hanepen.png') }}" class ="w-8">
</button>
...
<div id="hs-task_create-modal-{{ $user->id }}"
  ...
  <div
    ...
    <div
      ...
      <form action="{{ route('tasks.store', [$folderFirst->id]) }}" method="post" onsubmit="return validateFormTask()">
        @csrf
