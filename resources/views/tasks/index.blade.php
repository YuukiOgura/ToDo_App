              ...
              @foreach ($folders as $folder)
                <div id="horizontal-scroll-tab-{{ $folder->id }}" role="tabpanel"
                  ...
                  <div class="border rounded-lg overflow-hidden dark:border-gray-700">
                    <table class="min-w-1/2 divide-y divide-gray-200 dark:divide-gray-700">
                      <thead>
                        <tr>
                          <th scope="col" class="px-6 py-3 mx-auto text-xs font-medium text-gray-500 uppercase">
                            タイトル
                          </th>
                          <th scope="col" class="px-6 py-3 mx-auto text-xs font-medium text-gray-500 uppercase">期限
                          </th>
                          <th scope="col" class="px-6 py-3 tmx-auto text-xs font-medium text-gray-500 uppercase">完了
                          </th>
                          </th>
                          <th scope="col" class="px-6 py-3 mx-auto text-xs font-medium text-gray-500 uppercase">
                            アクション
